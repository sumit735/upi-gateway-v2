...
<head>
	...
	<title>Test Homepage - API Cloud</title>
</head>
				...
				<div class="uk-container" data-uk-navbar>
					<div class="uk-navbar-left">
						<a class="uk-navbar-item uk-logo" href="index.html">
							<img src="{{ asset('frontend/img/user/header-logo-6ohuZh.svg') }}" alt="logo" width="160" height="34">
						</a>
					...
					<li>
						<div class="uk-container">
							<div class="uk-grid-medium uk-grid" data-uk-grid="">
								<div class="uk-width-1-2@s uk-first-column">
									<div class="uk-overlay">
										<h1>One of the best global broker.</h1>
										<p class="uk-text-lead uk-visible@m">A trusted destination for traders worldwide, start your investment journey here</p>
				...
				<div class="uk-grid uk-child-width-1-2@s uk-child-width-1-3@m in-blog-4" data-uk-grid>
						...
						<div>
							<article class="uk-article">
								<h5 class="uk-margin-remove-bottom">
									<a class="uk-link-reset" href="#">Wall Street cautious on 'frothy' stocks, warn bitcoin bubble</a>
								</h5>
								<p class="uk-text-small uk-text-muted uk-margin-top">
									By <a class="uk-link-muted" href="#">Reuters</a>
					...
					<div class="uk-flex uk-flex-left">
						...
						<div>
							<article class="uk-article">
								<h5 class="uk-margin-remove-bottom">
									<a class="uk-link-reset" href="#">Will AUD/USD Hit 0.8000 In The Foreseeable Future?</a>
								</h5>
								<p class="uk-text-small uk-text-muted uk-margin-top">
									By <a class="uk-link-muted" href="#">JFD Team</a>
									<span class="uk-margin-small-left uk-margin-small-right">•</span>
									Jan 4, 2021
								</p>
								<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit ...</p>
					...
					<div class="uk-flex uk-flex-left uk-visible@m">
						...
						<div>
							<article class="uk-article">
								<h5 class="uk-margin-remove-bottom">
									<a class="uk-link-reset" href="#">How Can You Use Volatility to Your Advantage</a>
								</h5>
								<p class="uk-text-small uk-text-muted uk-margin-top">
									By <a class="uk-link-muted" href="#">Barry Norman</a>
									<span class="uk-margin-small-left uk-margin-small-right">•</span>
									Dec 16, 2020
								</p>
								<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit ...</p>
			...
			<div class="uk-container uk-text-small">
				<div class="uk-child-width-1-2@m" data-uk-grid="">
					<div class="in-footer-logo">
						<img src="img/in-lazy.gif" data-src="{{ asset('frontend/img/in-logo.svg') }}" alt="logo" width="127" height="27" data-uk-img="">
					</div>
				...
				<div class="uk-grid uk-margin-large-top">
					<div class="uk-width-1-1">
						<p class="copyright-text uk-heading-line"><span>Copyright ©2021 Liquid Inc. All Rights Reserved.</span></p>
						<p class="in-trading-risk">Trading derivatives and leveraged products carries a high level of risk, including the risk of losing substantially more than your initial investment. It
							is not suitable for everyone. Before you make any decision in relation to a financial product you should obtain and consider our Product Disclosure Statement (PDS) and
							Financial Services Guide (FSG) available on our website and seek independent advice if necessary</p>
					</div>
				</div>
			</div>
		</div>

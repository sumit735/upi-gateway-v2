            ...
            <div class="uk-container uk-container-expand">
                <div class="uk-grid" data-uk-height-viewport="expand: true">
                    <div class="uk-width-3-5@m uk-background-cover uk-background-center-right uk-visible@m uk-box-shadow-xlarge"
                        style="background-image: url({{ asset('frontend/img/signin.jpg') }});"></div>
                            ...
                            <div class="uk-width-3-5@m">
                                <div class="uk-text-center in-padding-horizontal@s">
                                    <a class="uk-logo" href="{{ url('/') }}">
                                        <img src="{{ asset('frontend/img/user/header-logo-6ohuZh.svg') }}"
                                            alt="logo" width="160">
                                    </a>
                                    ...
                                    <form id="registerForm" method="POST" action="{{ route('register.submit') }}"
                                        ...
                                        <div class="mb-3 d-flex justify-content-between">
                                            <span id="step1Indicator" class="fw-bold text-primary">Step 1: Personal
                                                Info</span>
                                            &nbsp;
                                            <span id="step2Indicator" class="fw-bold text-muted">Step 2: Account
                                                Details</span>
                                        </div>
                                        ...
                                        <div id="step1">
                                            ...
                                            <div class="uk-margin-small uk-width-1-1">
                                                <button type="button" id="continueBtn"
                                                    class="uk-button uk-button-primary uk-border-rounded uk-width-1-1">Continue</button>
                                            </div>
                                        </div>
                                        ...
                                        <div id="step2" class="d-none">
                                            ...
                                            <div class="uk-margin-small uk-width-1-1">
                                                <select name="state" class="uk-input uk-border-rounded" required>
                                                    ...
                                                    <option value="Gujarat"
                                                        {{ old('state') == 'Gujarat' ? 'selected' : '' }}>Gujarat</option>
                                                    <option value="Haryana"
                                                        {{ old('state') == 'Haryana' ? 'selected' : '' }}>Haryana</option>
                                                    ...
                                                    <option value="Kerala"
                                                        {{ old('state') == 'Kerala' ? 'selected' : '' }}>Kerala</option>
                                                    ...
                                                    <option value="Manipur"
                                                        {{ old('state') == 'Manipur' ? 'selected' : '' }}>Manipur</option>
                                                    <option value="Meghalaya"
                                                        {{ old('state') == 'Meghalaya' ? 'selected' : '' }}>Meghalaya
                                                    </option>
                                                    <option value="Mizoram"
                                                        {{ old('state') == 'Mizoram' ? 'selected' : '' }}>Mizoram</option>
                                                    <option value="Nagaland"
                                                        {{ old('state') == 'Nagaland' ? 'selected' : '' }}>Nagaland
                                                    </option>
                                                    <option value="Odisha"
                                                        {{ old('state') == 'Odisha' ? 'selected' : '' }}>Odisha</option>
                                                    <option value="Punjab"
                                                        {{ old('state') == 'Punjab' ? 'selected' : '' }}>Punjab</option>
                                                    <option value="Rajasthan"
                                                        {{ old('state') == 'Rajasthan' ? 'selected' : '' }}>Rajasthan
                                                    </option>
                                                    <option value="Sikkim"
                                                        {{ old('state') == 'Sikkim' ? 'selected' : '' }}>Sikkim</option>
                                                    ...
                                                    <option value="Tripura"
                                                        {{ old('state') == 'Tripura' ? 'selected' : '' }}>Tripura</option>
                                                    ...
                                                    <option value="Jammu and Kashmir"
                                                        {{ old('state') == 'Jammu and Kashmir' ? 'selected' : '' }}>Jammu
                                                        and Kashmir</option>
                                                    <option value="Ladakh"
                                                        {{ old('state') == 'Ladakh' ? 'selected' : '' }}>Ladakh</option>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <button type="button" id="backBtn"
                                                    class="uk-button uk-button-secondary uk-border-rounded">Back</button>
                                                <button type="submit"
                                                    class="uk-button uk-button-primary uk-border-rounded">Create
                                                    Account</button>
                                            </div>
                                        </div>
                                    </form>

                                    <p class="uk-margin-top uk-text-small">Already have an account? <a
